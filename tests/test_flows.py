...
def sample_flows_response():
    ...
    return [
        ["GEOID1", "GEOID2", "FULL1_NAME", "FULL2_NAME", "MOVEDIN", "MOVEDIN_M", "MOVEDOUT", "MOVEDOUT_M"],
        ["48001", "48003", "Anderson County, Texas", "Angelina County, Texas", "125", "15", "98", "12"],
        ["48001", "48005", "Anderson County, Texas", "Archer County, Texas", "45", "8", "67", "9"],
        ["48003", "48001", "Angelina County, Texas", "Anderson County, Texas", "87", "11", "134", "16"],
    ]
...
def sample_flows_with_breakdown_response():
    ...
    return [
        ...
        ["48001", "48003", "Anderson County, Texas", "Angelina County, Texas", "125", "15", "01", "1"],
        ["48001", "48003", "Anderson County, Texas", "Angelina County, Texas", "89", "12", "02", "1"],
...
class TestBreakdownProcessing:
    ...
    def test_process_breakdown_variables_padding(self):
        ...
        result = _process_breakdown_variables(
            data, ["AGE", "SEX"], recodes, breakdown_labels=False
        )
    ...
    def test_process_breakdown_variables_labels(self):
        ...
        result = _process_breakdown_variables(
            data, ["AGE", "SEX"], recodes, breakdown_labels=True
        )
...
class TestGeographyClauses:
    ...
    def test_msa_geography_clauses(self):
        ...
        for_clause, in_clause = _build_geography_clauses("metropolitan statistical area", 2015, None, None, None)
        assert "metropolitan statistical areas" in for_clause
        
        # Test year > 2015
        for_clause, in_clause = _build_geography_clauses("metropolitan statistical area", 2018, None, None, None)
