...
from pytidycensus.utils import (
    validate_state, validate_county, validate_year, validate_geography,
    build_geography_params, process_census_data, add_margin_of_error
)
...
class TestProcessCensusData:
    ...
    def test_process_tidy_format(self):
        ...
        data = [
            {"NAME": "Alabama", "B01001_001E": "5024279", "B01001_002E": "2449981", "state": "01"},
            {"NAME": "Alaska", "B01001_001E": "733391", "B01001_002E": "379169", "state": "02"}
        ]
    ...
    def test_process_wide_format(self):
        ...
        assert result["B01001_001E"].dtype in ["float64", "int64"]  # Allow both numeric types
    
    def test_process_with_geoid_creation(self):
        """Test GEOID creation from geography columns."""
        data = [
            {"NAME": "Harris County", "B01001_001E": "4000000", "state": "48", "county": "201"},
            {"NAME": "Dallas County", "B01001_001E": "2600000", "state": "48", "county": "113"}
        ]
        variables = ["B01001_001E"]
