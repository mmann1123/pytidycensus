...
def get_api_key():
    ...
    if not api_key:
        ...
        if debug_mode:
            ...
            try:
                api_key = input("Please enter your Census API key (or 'skip' to skip tests): ").strip()
...
class TestACSIntegration:
    ...
    def test_acs_summary_variable(self, setup_api_key):
        ...
        print(f"✓ Summary variable working: max population = {result['summary_value'].max()}")
    ...
    def test_acs_table_parameter(self, setup_api_key):
        ...
        print(f"✓ Table parameter working: {len(result['variable'].unique())} variables from B01003")
...
class TestDecennialIntegration:
    ...
    def test_basic_decennial_call(self, setup_api_key):
        ...
        print(f"✓ Retrieved 2020 decennial data: Vermont population = {result['value'].iloc[0]}")
...
class TestEnhancedFeaturesIntegration:
    ...
    def test_differential_privacy_warning(self, setup_api_key):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            dp_warnings = [warning for warning in w 
