...
class TestGetDecennial:
    ...
    def test_get_decennial_validation_errors(self):
        ...
        with pytest.raises(ValueError, match="Either a vector of variables or a table must be specified"):
    ...
    def test_get_decennial_multiple_variables(self):
        ...
        with patch('pytidycensus.decennial.CensusAPI') as mock_api_class, \
             patch('pytidycensus.decennial.process_census_data') as mock_process:
    ...
    def test_get_decennial_api_error(self, mock_api_class):
        ...
        with pytest.raises(Exception, match="Failed to retrieve decennial Census data: API request failed"):
            get_decennial(geography="state", variables="P1_001N", api_key="test")
